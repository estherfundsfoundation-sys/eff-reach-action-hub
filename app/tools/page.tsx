...
export default function InteractiveTools() {
  ...
  return <main className="tool-page">
    ...
    <section className="tool-hero"><p className="kicker">NO HOMEWORK. JUST YOUR NEXT MOVE.</p><h1>Tap. Answer.<br/><em>Get a plan.</em></h1><p>Twelve quick, private tools built around real student problems. Your answers stay in your browser and are not sent to EFF.</p></section>
