...
export default async function AmbassadorProfilePage({params}:{params:Promise<{slug:string}>}) {
  ...
  return <main className="public-ambassador-page">
    <div className="announcement">Published by the ambassador with explicit public-sharing permission.</div>
    ...
    <footer><div className="footer-links"><Link href="/">REACH Action Hub</Link><Link href="/ambassadors">Ambassador Directory</Link><a href="https://estherfundsfoundation.org/">Esther Funds Foundation</a></div><p className="disclaimer">The ambassador chooses what to publish. Private login and account information are never displayed.</p></footer>
  </main>;
}
